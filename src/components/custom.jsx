...
const Preference = (props) => {
  ...
  useEffect(() => {
    axios
      .get(`https://server-fo-ui.onrender.com/user/${id}`)
      .then((res) => {
  ...
  const setColors = (val) => {
    const endpoint = val ? `https://server-fo-ui.onrender.com/user/${id}` : `https://server-fo-ui.onrender.com/onlyColors`;
    axios
      .get(endpoint)
      .then((res) => {
        setUserPreferences((prevPreferences) => ({
  ...
  const ApplyChanges = (e) => {
    ...
    if(isAdmin)
    { 
      axios.post(`https://server-fo-ui.onrender.com/changePref`)
      scope = 'onlyColors'
    }
    axios
      .post(`https://server-fo-ui.onrender.com/${scope}`, {
